    ...
    return (
      <div>
        <h2 id="driver-heading">
          <Translate contentKey="uterApp.driver.home.title">Drivers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="uterApp.driver.home.createLabel">Create a new Driver</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {driverList && driverList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="uterApp.driver.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('surName')}>
                    <Translate contentKey="uterApp.driver.surName">Sur Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('license')}>
                    <Translate contentKey="uterApp.driver.license">License</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="uterApp.driver.home.notFound">No Drivers found</Translate>
            </div>
          )}
        </div>
