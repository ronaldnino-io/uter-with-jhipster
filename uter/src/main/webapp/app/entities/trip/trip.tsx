...
export class Trip extends React.Component<ITripProps, ITripState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="trip-heading">
          <Translate contentKey="uterApp.trip.home.title">Trips</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="uterApp.trip.home.createLabel">Create a new Trip</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {tripList && tripList.length > 0 ? (
            <Table responsive aria-describedby="trip-heading">
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('date')}>
                    <Translate contentKey="uterApp.trip.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="uterApp.trip.driver">Driver</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="uterApp.trip.vehicle">Vehicle</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {tripList.map((trip, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <TextFormat type="date" value={trip.date} format={APP_LOCAL_DATE_FORMAT} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="uterApp.trip.home.notFound">No Trips found</Translate>
            </div>
          )}
        </div>
